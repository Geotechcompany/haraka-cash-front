      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            <button key={o.t} className="card-soft p-5 text-left hover:shadow-elevated transition-shadow">
        ...
        <div className="mt-8 grid lg:grid-cols-2 gap-6">
          <form onSubmit={(e) => { e.preventDefault(); toast.success("Message sent — we'll be in touch shortly"); }} className="card-soft p-6 space-y-4">
            <h2 className="text-lg font-semibold">Send us a message</h2>
            <div className="space-y-1.5"><Label>Subject</Label><Input className="h-11 rounded-xl" placeholder="I need help with..." required /></div>
            <div className="space-y-1.5"><Label>Message</Label><Textarea rows={5} className="rounded-xl" placeholder="Tell us what's going on" required /></div>
            <Button type="submit" className="w-full h-11 rounded-xl gradient-brand text-white font-semibold">Send message</Button>
          </form>
